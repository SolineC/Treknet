...
function afficher_pied_de_page($langue){
    if($langue==0){ ?>
        <footer class= "footer">
    <div class= "container">
        <div class= "row">
            <div class= "footer-col">
                ...
                <ul>
                    <li><a href="https://decathlon.fr">Conditions d'utilisation</a></li>
    ...
    <div class= "container">
        <div class= "row">
            <div class= "footer-col">
                ...
                <ul>
                    <li><a href="https://decathlon.fr">Décathlon</a></li>
                    <li><a href="https://www.fsgt.org/">FSGT</a></li>
                    <li><a href="https://www.us-fontenay.com/">USF</a></li>
                </ul>
            </div>
            <div class= "footer-col">
                <h3>SOBRE LOS REDES SOCIALES</h3>
                <ul>
                    <li><a href="https://fr-fr.facebook.com/ParkourFontenay/">Facebook</a></li>
                    <li><a href="https://www.instagram.com/parkour_fsb/">Instagram</a></li>
                    <li><a href="https://www.youtube.com/channel/UCu6uGPnipaefRu0nxM-L-8A">Youtube</a></li>
            ...
            <div class= "footer-col">
                <h3>QUIÈN SOMOS ?</h3>
                <ul>
                    <li><a href="apropo.html">Sobre nosotros</a></li>
                    <li><a href="coach.html">Nuestro projecto</a></li>
